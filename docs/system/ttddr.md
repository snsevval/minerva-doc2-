...
<div class="pipeline__bar">
  ...
  <span class="pipeline__label">ttd-dr — claim verification flow</span>
</div>
<div class="pipeline__body">Extracted relation          # post-Critic Layer
    ↓
    Claim formulation         # relation → natural language
    ↓
    FAISS search              # top-3 chunks from 29,545 textbook chunks
    ↓
    GPT-4o-mini judgment      # temperature=0, max_tokens=256
    ↓
    ├── SUPPORTED    → Neo4j write
